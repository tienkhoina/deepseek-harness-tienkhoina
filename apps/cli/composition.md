...
flowchart LR
  ...
  plugin_dsh_base_web_search_openai["web-search-openai<br/>@deepseek-ai/dsh-web-search-openai"]
  cfg --> plugin_dsh_base_web_search_openai
...
| `web-search-openai` | `@deepseek-ai/dsh-web-search-openai` |
