...
export const en = {
  ...
  modelDescriptionPlaceholder: 'Optional description',
  modelInputModalities: 'Input modalities',
  modelInputModalitiesPlaceholder: 'Comma-separated: text, image, audio',
  modelReasoningEfforts: 'Reasoning efforts',
  modelReasoningEffortsPlaceholder: 'Max level: low, medium, high, xhigh, or max (default: high). Use "false" to disable',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelDescription: '描述',
  modelDescriptionPlaceholder: '可选描述',
  modelInputModalities: '输入模态',
  modelInputModalitiesPlaceholder: '逗号分隔：text, image, audio',
  modelReasoningEfforts: '推理级别',
  modelReasoningEffortsPlaceholder: '最高级别：low, medium, high, xhigh 或 max（默认：high）。使用 "false" 禁用',
  contextWindow: '上下文窗口',
